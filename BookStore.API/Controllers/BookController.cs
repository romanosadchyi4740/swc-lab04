...
public class BookController : ControllerBase
{
	...
	{
		var id = await _bookService.UpdateBook(bookId, bookDto.Title, bookDto.Price, bookDto.NumberInStock,
			bookDto.Language, bookDto.ImgUrl, bookDto.Description, bookDto.AuthorIds, bookDto.GenreIds,
			bookDto.PaymentIds);
		return Ok(id);
	}
